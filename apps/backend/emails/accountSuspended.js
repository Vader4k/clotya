...
export const accountSuspendedEmail = (name) => {
  const bodyContent = `
    ...
    <p style="font-size: 15px; color: #6b7280; text-align: center; margin: 0 0 32px 0; line-height: 1.6;">
      Hi ${name}, your Clotya account has been suspended. You will not be able to log in or place orders until your account is reactivated.
    </p>
...
export const accountReactivatedEmail = (name) => {
  const bodyContent = `
    ...
    <p style="font-size: 15px; color: #6b7280; text-align: center; margin: 0 0 32px 0; line-height: 1.6;">
      Hi ${name}, great news! Your Clotya account has been reactivated. You can now log in and continue shopping as usual.
    </p>
