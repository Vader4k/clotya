...
const EmptyCart = () => {
    return (
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 font-jost">
            <div className="text-center flex flex-col items-center gap-6">
                ...
                <Link
                    href="/shop"
                    className="mt-4 bg-black text-white px-10 py-3 text-xs font-medium hover:bg-gray-800 transition-colors uppercase tracking-widest font-jost"
                >
                    Go to Shop
                </Link>
            </div>
