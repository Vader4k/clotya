    ...
    <footer className='xl:h-[800px] font-jost'>
      ...
      <div className='w-full bg-white text-black h-full max-h-1/2 py-10 xl:py-20 2xl:py-10 px-3 mb-16 xl:mb-0'>
        <div className='w-full max-w-7xl mx-auto h-full flex flex-col justify-between'>
          <div className="grid xl:grid-cols-6 gap-10 w-full">
            <div className="col-span-2 grid gap-2">
              <Image src="/logo-black.png" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" alt="Logo" width={130} height={100} />
          ...
          <div className="w-full border-t border-neutral-200 mt-10 mb-10 lg:mb-0 pt-5">
            <p className="text-center text-sm text-neutral-600">© 2026 Stylr. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
