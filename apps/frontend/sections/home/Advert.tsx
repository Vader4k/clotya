...
const Advert = () => {
  return (
    <section className="w-full flex flex-col xl:flex-row items-start h-160 md:h-220 xl:h-100 gap-8 mb-20">
      <div className="w-full xl:max-w-[70%] h-full advert1 flex flex-col items-start justify-center font-jost gap-3 p-6 md:p-10">
      ...
      <div className="w-full xl:max-w-[30%] h-full advert2 flex flex-col gap-3 font-jost items-center justify-center text-white">
