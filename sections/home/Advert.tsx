...
const Advert = () => {
  return (
    <section className="w-full flex flex-col 2xl:flex-row items-start h-220 2xl:h-100 gap-8 mb-20">
      <div className="w-full 2xl:max-w-[70%] h-full advert1 flex flex-col items-start justify-center font-jost gap-3 p-10">
